<aside class="main-sidebar sidebar-dark-danger elevation-4">
  ...
  <div class="sidebar">
    <div class="user-panel mt-3 pb-3 mb-3 d-flex">
      <div class="image">
        <img src="{{ Auth::user()->image ? asset('dist/img/user/'.Auth::user()->image) : asset('dist/img/avatar5.png') }}?{{ Auth::user()->updated_at }}" class="img-circle elevation-2" alt="User Image">
      </div>
      <div class="info">
