    ...
    <div class="col-md-3">
      <div class="card card-danger card-outline">
        <div class="card-body box-profile">
          ...
          <img class="profile-user-img img-fluid img-circle" src="{{ $user->image ? asset('dist/img/user/'.$user->image) : asset('dist/img/avatar5.png') }}" alt="User profile picture">
          </div>
              ...
              <form action="{{ route('user.updateImage', $user->id) }}" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group row">
                  <div class="col-sm-2 text-center">
                    <img id="imageView" class="profile-user-img img-fluid img-circle" src="{{ $user->image ? asset('dist/img/user/'.$user->image) : asset('dist/img/avatar5.png') }}" alt="User profile picture">
                  </div>
                  <div class="col-sm-10">
